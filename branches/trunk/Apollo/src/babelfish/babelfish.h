...
// ============================================================================
...
#if defined(WIN32)
  #ifdef BABELFISH_EXPORTS
    #define BABELFISH_API __declspec(dllexport)
  #else
    #define BABELFISH_API __declspec(dllimport)
  #endif
#elif defined(__GNUC__) && (__GNUC__ >= 4) // both mac and linux gcc ver. above 4 support visibility for c and c++
  #if defined(BABELFISH_EXPORTS)
    ...
    #define BABELFISH_API __attribute__ ((visibility("default")))
  #else
    #define BABELFISH_API
  #endif
#else
  #define BABELFISH_API
#endif
