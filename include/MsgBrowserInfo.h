...
public:
  ...
  #define Msg_BrowserInfo_BeginTrackCoordinates_Signature_Win32HWND Navigation_ContextNativeWindow_Signature_Win32HWND
  #define Msg_BrowserInfo_BeginTrackCoordinates_Signature_Win32HWNDTarget Navigation_ContextNativeWindow_Signature_Win32HWNDTarget
};
