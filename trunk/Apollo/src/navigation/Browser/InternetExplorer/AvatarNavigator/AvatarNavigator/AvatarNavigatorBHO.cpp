// AvatarNavigatorBHO.cpp : Implementation of CAvatarNavigatorBHO

#include "stdafx.h"
#include "AvatarNavigatorBHO.h"


// CAvatarNavigatorBHO

STDMETHODIMP CAvatarNavigatorBHO::SetSite(IUnknown* pUnkSite)
{
    if (pUnkSite != NULL)
    {
    ...
    return IObjectWithSiteImpl<CAvatarNavigatorBHO>::SetSite(pUnkSite);
}

void STDMETHODCALLTYPE CAvatarNavigatorBHO::OnDocumentComplete(IDispatch *pDisp, VARIANT *pvarURL)
{
    ...
    //    MessageBox(hwnd, L"CAvatarNavigatorBHO::OnDocumentComplete", L"BHO", MB_OK);
    //}
...
void CAvatarNavigatorBHO::RemoveImages(IHTMLDocument2* pDocument)
{
