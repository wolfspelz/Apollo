...
public:
  ...
  #define Msg_BrowserInfo_BeginTrackCoordinates_Signature_Type Navigation_SrpcMethod_NativeWindow_Signature_Type
    #define Msg_BrowserInfo_BeginTrackCoordinates_Signature_Type_Firefox Navigation_SrpcMethod_NativeWindow_Signature_Type_Firefox
    #define Msg_BrowserInfo_BeginTrackCoordinates_Signature_Type_InternetExplorer Navigation_SrpcMethod_NativeWindow_Signature_Type_InternetExplorer
    #define Msg_BrowserInfo_BeginTrackCoordinates_Signature_Type_Chrome Navigation_SrpcMethod_NativeWindow_Signature_Type_Chrome
  #define Msg_BrowserInfo_BeginTrackCoordinates_Signature_Version Navigation_SrpcMethod_NativeWindow_Signature_Version
  ...
  #define Msg_BrowserInfo_BeginTrackCoordinates_Signature_InnerWidth Navigation_SrpcMethod_NativeWindow_Signature_InnerWidth
  #define Msg_BrowserInfo_BeginTrackCoordinates_Signature_InnerHeight Navigation_SrpcMethod_NativeWindow_Signature_InnerHeight
};
